...
def train_all_models():
    ...
    base_params = {'s0': 100, 'T': 200, 'v': 1, 'q0': 0, 'c0': 100_000, 'sigma': 0.025, 'drift': 0.005, 'gamma': 0.95, 'itp': 0.1, 'ms': 0.02, 'tf': 2, 'itfp': 10, 'seed_sequence': seed_sequence}
    illiquid_params = {'s0': 100, 'T': 200, 'v': 1, 'q0': 0, 'c0': 100_000, 'sigma': 0.05, 'drift': 0.005, 'gamma': 0.95, 'itp': 0.2, 'ms': 0.02, 'tf': 1, 'itfp': 10 ,'seed_sequence': seed_sequence}
    ...
    for itp in params['itp']:
        ...
        params_copy['itp'] = itp
        for model_type in model_types:
            train_and_save_model(illiquid_params, 'itp', itp, current_time, model_type)
